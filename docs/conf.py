...
breathe_projects = { "RTRlib": "doxyxml/" }
breathe_default_project = "RTRlib"
...
latex_documents = [
  ('index', 'RTRlib.tex', 'RTRlib Documentation',
   'RTRlib', 'manual'),
]
...
man_pages = [
    ('index', 'RTRlib', 'RTRlib Documentation',
     ['RTRlib'], 1)
]
...
texinfo_documents = [
  ('index', 'RTRlib', 'RTRlib Documentation',
   'RTRlib', 'RTRlib', 'The RPKI RTR Client C Library.',
   'Miscellaneous'),
]
