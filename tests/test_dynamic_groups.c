...
int main(void)
{
	...
	groups[0].sockets = rtr_malloc(sizeof(struct rtr_socket *));
	...
	group2.sockets = rtr_malloc(sizeof(struct rtr_socket *));
	...
	group3.sockets = rtr_malloc(sizeof(struct rtr_socket *));
	...
	group4.sockets = rtr_malloc(sizeof(struct rtr_socket *));
	...
	group5.sockets = rtr_malloc(sizeof(struct rtr_socket *));
	...
	rtr_free(group2.sockets);
	rtr_free(group3.sockets);
	rtr_free(group4.sockets);
	rtr_free(group5.sockets);
}
