...
RTRLIB_EXPORT void rtr_pfx_table_for_each_ipv4_record(struct rtr_pfx_table *pfx_table, rtr_pfx_for_each_fp fp,
						      void *data)
{
	assert(pfx_table);
...
RTRLIB_EXPORT void rtr_pfx_table_for_each_ipv6_record(struct rtr_pfx_table *pfx_table, rtr_pfx_for_each_fp fp,
						      void *data)
{
	assert(pfx_table);
