 ...
 */
void rtr_pfx_table_for_each_ipv4_record(struct rtr_pfx_table *pfx_table, rtr_pfx_for_each_fp fp, void *data);
 ...
 * @param[in] data This parameter is forwarded to the callback function.
 */
void rtr_pfx_table_for_each_ipv6_record(struct rtr_pfx_table *pfx_table, rtr_pfx_for_each_fp fp, void *data);
