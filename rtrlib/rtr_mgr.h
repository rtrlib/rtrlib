 ...
 */
enum rtr_pfx_rtvals rtr_mgr_validate(struct rtr_mgr_config *config, const uint32_t asn,
 ...
 */
enum rtr_aspa_status rtr_mgr_verify_as_path(struct rtr_mgr_config *config, uint32_t as_path[], size_t len,
 ...
 */
enum rtr_spki_rtvals rtr_mgr_get_spki(struct rtr_mgr_config *config, const uint32_t asn, uint8_t *ski,
 ...
 */
void rtr_mgr_for_each_ipv4_record(struct rtr_mgr_config *config, rtr_pfx_for_each_fp fp, void *data);
 ...
 * @param[in] data This parameter is forwarded to the callback function.
 */
void rtr_mgr_for_each_ipv6_record(struct rtr_mgr_config *config, rtr_pfx_for_each_fp fp, void *data);
