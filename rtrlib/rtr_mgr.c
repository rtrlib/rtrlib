...
RTRLIB_EXPORT inline enum rtr_pfx_rtvals rtr_mgr_validate(struct rtr_mgr_config *config, const uint32_t asn,
...
/* cppcheck-suppress unusedFunction */
RTRLIB_EXPORT inline enum rtr_aspa_status rtr_mgr_verify_as_path(struct rtr_mgr_config *config, uint32_t as_path[],
...
/* cppcheck-suppress unusedFunction */
RTRLIB_EXPORT inline enum rtr_spki_rtvals rtr_mgr_get_spki(struct rtr_mgr_config *config, const uint32_t asn,
...
RTRLIB_EXPORT inline void rtr_mgr_for_each_ipv4_record(struct rtr_mgr_config *config,
						       void(fp)(const struct rtr_pfx_record *, void *data), void *data)
{
	rtr_pfx_table_for_each_ipv4_record(config->pfx_table, fp, data);
}
...
RTRLIB_EXPORT inline void rtr_mgr_for_each_ipv6_record(struct rtr_mgr_config *config,
						       void(fp)(const struct rtr_pfx_record *, void *data), void *data)
{
	rtr_pfx_table_for_each_ipv6_record(config->pfx_table, fp, data);
}
